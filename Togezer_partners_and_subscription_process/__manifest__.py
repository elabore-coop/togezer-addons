...
{
    'name': 'togezer_partners_and_subscription_process',
    'version': '13.0.1.0.10',
    'author': 'Elabore',
    'maintainer': 'False',
    ...
    'license': '',
    'category': 'False',
    'summary': 'Customization of Partner model and subscription process for Togezer - https://togezer.travel',
    'description': """
...
=========================================
The module's goal is to customize Togezer subscription formular.
...
""",
    ...
    'data': [
        ...
        'views/auth_signup_togezer_fields.xml',
        'views/menu.xml',
        'views/partner.xml',
        'views/company_category.xml',
        'views/company_speciality.xml'
    ],
